    ...
    >
      <DialogContent className="max-h-[90vh] max-w-lg overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Define el productor, la ubicación y las unidades de medición del rancho.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <FormSection
            ...
            description="Identificación y productor responsable."
          >
          ...
          <FormSection title="Ubicación" description="Dirección y coordenadas de referencia.">
            <div className="grid gap-4 sm:grid-cols-2">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    ...
                    >
                      <SelectTrigger>
                        <SelectValue
                          placeholder={selectedCountryIso2 ? 'Estado…' : 'Elige país primero'}
                        />
                      </SelectTrigger>
                      <SelectContent>
                        {states.map((s) => (
          ...
          <FormSection title="Medición y estado">
            <div className="grid gap-4 sm:grid-cols-2">
