          ...
          <tbody>
            {data.variables.map((v) => (
              <tr key={v.key} className="border-t">
                ...
                <td className="px-2 py-1 text-right font-medium tabular-nums">{fmt(v.mean)}</td>
                <td className="px-2 py-1 text-right tabular-nums">{fmt(v.min)}</td>
                <td className="px-2 py-1 text-right tabular-nums">{fmt(v.max)}</td>
                <td className="px-2 py-1 text-right tabular-nums">{fmt(v.stddev)}</td>
